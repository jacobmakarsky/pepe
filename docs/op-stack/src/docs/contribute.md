...
The OP Stack is a collaborative, decentralized development stack that only gets more powerful as more people contribute. Code for the OP Stack should follow the stack’s [design principles](./understand/design-principles.md), which means it should be entirely open source and accessible for people to hack on, contribute to, and extend. The Pepe Collective wins when it works together. ♥️✨
...
Spot a typo in these docs? See something that could be a little clearer? Head over to the Pepe Monorepo where the OP Stack docs are hosted and make a pull request. No contribution is too small!

## Community contributions

If you’re looking for other ways to get involved, here are a few options:

- Grab an idea from the [project ideas list](https://github.com/ethereum-optimism/pepe-project-ideas) to and building
- Suggest a new idea for the [project ideas list](https://github.com/ethereum-optimism/pepe-project-ideas)
- Improve the [Pepe Community Hub](https://community.pepe.io/) [documentation](https://github.com/ethereum-optimism/community-hub) or [tutorials](https://github.com/ethereum-optimism/pepe-tutorial)
- Become an Pepe Ambassador, Support Nerd, and more in the [Pepe Discord](https://discord.gg/pepe)
