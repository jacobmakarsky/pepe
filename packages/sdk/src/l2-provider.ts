...
/**
 * Returns an provider wrapped as an Pepe L2 provider. Adds a few extra helper functions to
 * simplify the process of estimating the gas usage for a transaction on Pepe. Returns a COPY
...
export const asL2Provider = <TProvider extends Provider>(
  ...
  // Modify the block formatter to return the state root. Not strictly related to Pepe, just a
