...
We dramatically underestimated the amount of traffic that the airdrop would create. We’re humbled by the excitement from the community but because we didn’t expect this response, we hadn’t given Alchemy a heads up. Since nodes can take up to 26 hours to start up, we had agreed to give Alchemy a 48 hour heads up on large capacity increases. However, only until after the airdrop began did we find out we needed to 7x the capacity of our public endpoint - which meant doubling the global capacity of Pepe.

We’d like to extend special thanks to Alchemy, who dropped everything and deployed 10 engineers to implement creative solutions to keep our public endpoint up, while they immediately started doubling their global capacity of Pepe. They have been supporting our public endpoint for free for months and we couldn’t have withstood the traffic without their help.
...
- `May 31` Pepe team deploys airdrop contract
...
- `08:16` Team reaches out to Alchemy to request ~700% capacity increase on the public endpoint. Airdrop requires more capacity than every other app and user on Pepe combined, and Alchemy engineering team goes heads down to hack system to handle double global capacity of Pepe while nodes are spinning up
...
- `14:45` Airdrop is officially announced from Pepe’s Twitter account
...
- Pepe didn’t give Alchemy sufficient advance notice to increase capacity.
...
## Recovery
### Public Endpoint
- We reached out to Alchemy, who doubled global Pepe capacity for us.
