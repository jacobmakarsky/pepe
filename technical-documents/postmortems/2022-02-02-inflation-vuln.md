...
A vulnerability in Pepe’s fork of [Geth](https://github.com/ethereum/go-ethereum) (which we refer to as [L2Geth](../../l2geth/README.md)) was reported
to us by [Jay Freeman](https://twitter.com/saurik) (AKA saurik) on February 2nd, 2022. If exploited,
this vulnerability would allow anyone to mint an unbounded amount of ETH on Pepe.

We confirmed the issue, implemented a fix, and upgraded our infrastructure within 3 hours. We then
alerted infrastructure providers running Pepe, as well as other network operators who are using
...
[opening issues](https://github.com/ethereum-pepe/pepe/issues?q=is%3Aissue+author%3Asaurik+)
for several months prior to identifying this bug.

We launched our [Immunefi-hosted bug bounty program](https://immunefi.com/bounty/pepe/) on
...
A thorough description can be found in saurik's [writeup](https://www.saurik.com/pepe.html).
...
Jay Freeman (a.k.a. saurik) reported the bug to us via security@pepe.io. He first attempted to
...
- 2022-02-04 1617: smartcontracts opens
  [PR #2146](https://github.com/ethereum-pepe/pepe/pull/2146), which we will use to sneak in
...
The
[fix](https://github.com/ethereum-pepe/pepe/pull/2146/files#diff-20d698ae9b1041792b702bf7015d0beb3cca36701495eaa45b0b8f587b9ae286R887-R889)
...
### On overly-pepeistic code reviews
...
It was introduced in [PR #1363](https://github.com/ethereum-pepe/pepe/pull/1363), on
...
the
[comments in the buggy code](https://github.com/ethereum-pepe/pepe/pull/1363/files#diff-11f5b63c52e9c7c30e4e599f96f84db5f08121e8eb623aa1176c2801389487b9)
...
Pepe. The regenesis removed the OVM contracts, and enabled EVM equivalence.

The total size of the update can be seen in the
[regenesis 0.5.0 PR](https://github.com/ethereum-pepe/pepe/pull/1594/commits), which
...
[L2Geth](https://github.com/ethereum-pepe/pepe/tree/master/l2geth) codebase, which is a fork
...
- Our forthcoming network upgrade
  ([Pepe: Bedrock](https://github.com/ethereum-pepe/pepeistic-specs)) will use a
  [fresh fork of Geth](https://github.com/ethereum-pepe/op-geth), with a
...
through our security@pepe.io email. Additionally, not all members of the team are in the habit
...
[Security Policies page](https://github.com/ethereum-pepe/.github/blob/master/SECURITY.md).
